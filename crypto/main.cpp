...
int main() {
    ...
    if (mode == "encrypt") {
        ...
        if(input_file_string == "default")
            input_file_string = "/home/stud/Desktop/CryptoProg/crypto/text_file";
        ...
        if(output_file_string == "default")
            output_file_string = "/home/stud/Desktop/CryptoProg/crypto/encrypted_text_file";
        ...
        ofstream user_password_file("/home/stud/Desktop/CryptoProg/admin/user_password_file");
        StringSource(pass, true, new FileSink(user_password_file));
        ofstream key_file("/home/stud/Desktop/CryptoProg/admin/key_file");
        ArraySource(key, sizeof(key), true, new FileSink(key_file));
        ofstream IV_file("/home/stud/Desktop/CryptoProg/admin/iv_file");
        ...
        string user_pass;
        FileSource("/home/stud/Desktop/CryptoProg/admin/user_password_file", true, new StringSink(user_pass));
        if (pass != user_pass) {
        ...
        cin >> input_file_string;
        if(input_file_string == "default")
            input_file_string = "/home/stud/Desktop/CryptoProg/crypto/encrypted_text_file";
        ifstream input_check(input_file_string);
        if(input_check.is_open() == 0) {
        ...
        cin >> output_file_string;
        if(output_file_string == "default")
            output_file_string = "/home/stud/Desktop/CryptoProg/crypto/decrypted_text_file";
        ifstream output_check(output_file_string);
        if(output_check.is_open() == 0) {
        ...
        byte key[Tiger::DIGESTSIZE];
        FileSource("/home/stud/Desktop/CryptoProg/admin/key_file", true, new ArraySink(key, sizeof(key)));
        byte IV[ AES::BLOCKSIZE ];
        FileSource("/home/stud/Desktop/CryptoProg/admin/iv_file", true, new ArraySink(IV, sizeof(IV)));
